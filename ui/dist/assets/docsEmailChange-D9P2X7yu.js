function e(e){let i=app.utils.getApiExampleURL(),a=[{title:`请求邮箱变更`,content:n},{title:`确认邮箱变更`,content:r}],o=store({activeActionIndex:0});return t.div({pbEvent:`apiPreviewEmailChange`,className:`content`},t.p(null,`Sends ${e.name} email change request.`),t.p(null,`邮箱变更成功后，该特定记录之前发出的所有认证令牌将失效（如果用户尚未验证，将被标记为已验证）。`),app.components.codeBlockTabs({className:`sdk-examples m-t-sm`,historyKey:`pbLastSDK`,tabs:[{title:`JS SDK`,language:`js`,value:`
            ...
            `}]})]}function r(e){return[t.div({className:`block`},t.strong(null,`API详情`)),t.div({className:`alert success api-preview-alert`},t.span({className:`label method`},`POST`),t.span({className:`path`},`/api/collections/${e.name}/confirm-email-change`)),t.table({className:`api-preview-table body-params`},t.thead(null,t.tr(null,t.th({className:`min-width txt-primary`},`请求体参数`),t.th({className:`min-width`},`类型`),t.th(null,`描述`))),t.tbody(null,t.tr(null,t.td({className:`min-width`},`token `,t.em(null,`（必需）`)),t.td({className:`min-width`},t.span({className:`label`},`字符串`)),t.td(null,`来自邮箱变更请求邮件的令牌。`)),t.tr(null,t.td({className:`min-width`},`password `,t.em(null,`（必需）`)),t.td({className:`min-width`},t.span({className:`label`},`字符串`)),t.td(null,`用于确认邮箱变更的账户密码。`)))),t.div({className:`block m-t-base m-b-sm`},t.strong(null,`示例响应`)),app.components.codeBlockTabs({tabs:[{title:204,value:`null`},{title:400,value:`
                {
                  "status": 400,
                  "message": "验证提交的数据时发生错误。",
                  "data": {
